...
If LoRA training fails with a `torchao` version error, pull the latest code
and rerun. As a hard fallback on Kaggle:

```bash
pip uninstall -y torchao
```

Then restart the kernel and run training again.
